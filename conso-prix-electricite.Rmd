...
Le pas des données SWAP est horaire, tandis que celui des données de consommation est le quart d'heure. Il est très probable que nous utilisions un pas plus grand.
...
A partir de 2021 en revanche la tendance se rapproche d'une exponentielle. Il faudra se demander si nous conservons ces données par la suite. \
